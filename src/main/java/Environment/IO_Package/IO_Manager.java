...
public class IO_Manager { // Singleton class
    ...
    public static final String workingDirectory = "D:\\MAPF\\MAPF java\\src"; // absolute path to src
    public static final String testResources_Directory = buildPath(new String[]{workingDirectory, "test\\resources"});
    public static final String resources_Directory = buildPath(new String[]{System.getProperty("user.dir"), "test\\resources"});
