...
public class CBS_Solver extends A_Solver {
     ...
     */
    protected final CBSCostFunction costFunction;
    /**
     ...
     */
    public void initOpen(ConstraintSet initialConstraints) {
...
//        node.rightChild = generateNode(node, constraints[1], false);
     ...
     */
    protected boolean addToOpen(CBS_Node node) {
     ...
     */
    protected Solution solveSubproblem(Agent agent, Solution currentSolution, ConstraintSet constraints) {
...
//        }
     ...
     */
    public Solution solutionFromGoal(CBS_Node goal) {
        if(goal == null){
            return null;
        }
        else{
    ...
    protected class CBS_Node implements Comparable<CBS_Node>{
        ...
        private ConstraintSet addedConstraintSet;
         ...
         */
        public CBS_Node(Solution solution, float solutionCost, Constraint addedConstraint, ConstraintSet addedConstraintSet, CBS_Node parent) {
            this.solution = solution;
            this.solutionCost = solutionCost;
            this.addedConstraint = addedConstraint;
            this.addedConstraintSet = addedConstraintSet;
            this.parent = parent;
        }
        ...
        public  ConstraintSet getAddedConstraintSet() {
            return addedConstraintSet;
        }
