...
public class ConflictManager implements I_ConflictManager {
        ...
        */
        for (Agent agentMovingToPrevPosition : agentsMovingToPrevLocations) {
            ...
            if( time <= otherAgentPlan.getEndTime() && otherAgentPlan.moveAt(time).prevLocation.intersectsWith(nextLocation)){
                ...
                //System.out.println("time " + swappingConflict_addedAgentFirst.time + " " + swappingConflict_addedAgentFirst.agent1 + " " + swappingConflict_addedAgentFirst.agent2 + " " + swappingConflict_addedAgentFirst.location);
    ...
    protected void addVertexConflicts(TimeLocation timeLocation, Agent agent, Set<Agent> agentsAtTimeLocation) {
        ...
        for (Agent agentConflictsWith : agentsAtTimeLocation) {
            ...
            //System.out.println("time " + vertexConflict.time + " " + vertexConflict.agent1 + " " + vertexConflict.agent2 + " " + vertexConflict.location);
        }
    }
...
//        System.out.println(allConflicts);
